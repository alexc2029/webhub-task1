        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <p class="lead1">
                Echipa ScanStart vă stă la dispoziție cu consultanță privind automatizarea proceselor din cadrul biroului notarial.
              </p>              
              <p>
                Cu ajutorul aplicațiilor dedicate multe procese pot fi automatizate. De la scanarea documentelor și extragerea textelor (OCR) până la configurarea rețelei sau a soluțiilor de backup, echipa ScanStart vă poate sfătui și împreună cu dvs. să aleagă cea mai bună soluție.
                <br /><br />
                Aplicațiile propuse pot fi aplicații deja existente sau pot fi dezvoltate la cerere.
              </p>
            </div>
            <div class="col-md-6 col-sm-12">
              <h4 class="text-center">
              ...
              <p class="lead1">
                Echipa ScanStart vă ajută cu instalarea și configurarea soluției ScanStart.
              </p>
              <p>
                De asemenea, vă putem ajuta cu configurarea rețelei, a calculatoarelor și a imprimantelor din biroul dvs. notarial.
              </p>
