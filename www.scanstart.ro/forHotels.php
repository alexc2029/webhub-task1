    ...
    <main>        
      ...
      <div class="row">
        <div class="container">
            ...
            ScanStart for Hotels
              </h4> 
              <p class="lead1">
                Echipa ScanStart vă pune la dispoziție o soluție pentru hotelul dumneavoastră.
              </p>              
              <p>
              ScanStart for Hotels oferă posibilitatea integrării cu Pynbooking pentru reducerea timpului de preluare a datelor personale, cât și pentru facilitarea procesului de self-check-in.
                <br /><br />
                Pentru protecția datelor personale preluate, cât și a datelor stocate existente, echipa ScanStart vă oferă și soluția <a href="adBlocker.php" class="btn-link-1">ScanStart AdBlocker </a>, un dispozitiv care se conectează la router-ul dvs. și blochează reclamele cu potențial de risc pe toate dispozitivele conectate la rețea. 
              </p>
            </div>
