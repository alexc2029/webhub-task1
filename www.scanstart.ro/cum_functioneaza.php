        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <p>
			  Datele de pe actul de identitate sunt preluate complet cu ajutorul unui scanner special și transformate în text. Datele sunt salvate într-o bază de date.
			  </p>
            </div>
            <div class="wow col-md-6 col-sm-12 fadeInRight text-center" data-wow-duration='2s'>
		  ...
		  <div class="row">
		    <div class="col-md-6 col-sm-12">
			  <p class="lead1">
                Prelucrare și utilizare date
              </p>
			  <p>
După scanare, datele sunt disponibile în format electronic în aplicația ScanStart, de pe oricâte stații de lucru. Din aplicație pot fi generate direct documente Word sau datele pot fi preluate cu Copy+Paste și introduse în alte aplicații. De asemenea, datele sunt direct accesibile prin intermediul unui AddOn direct în Microsoft Word.
</p>
            </div>
            <div class="wow col-md-6 col-sm-12 fadeInRight text-center" data-wow-duration='2s'>
              <img src="images/working2.png" alt=""/>
            </div>
		  ...
		  <div class="row>
		     <div class="col-md-12 col-sm-12">
			   <a href="functionalitati.php" class="btn-link-1">Vezi toate funcționalitățile</a>
			 </div>
		  </div>
		</div>  
      </section>
